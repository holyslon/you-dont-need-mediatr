...
public class MediatrVsNative
{
    ...
    [Benchmark()]
    public Task<(int, int)> NativeTransient() => _nativeServiceProviderTransient.GetService<CalculationUnit>().DoCalculate(7);
    ...
    [Benchmark()]
    public Task<(int, int)> NativeSingleton() => _nativeServiceProviderSingleton.GetService<CalculationUnit>().DoCalculate(7);
